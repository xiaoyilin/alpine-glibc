...
RUN apk --update --no-cache add ca-certificates bash wget tzdata && \
        ...
        apk add glibc-2.32-r0.apk glibc-bin-2.32-r0.apk glibc-i18n-2.32-r0.apk glibc-dev-2.32-r0.apk  && \
        rm glibc-2.32-r0.apk glibc-bin-2.32-r0.apk glibc-i18n-2.32-r0.apk glibc-dev-2.32-r0.apk && \
